...
local function init(self)
	...
	require(self.scriptPath.."weapons_grapple")
...
--Brute
	...
	modApi:setText("Brute_Grapple_Upgrade2", "Reactivate")
	modApi:setText("Brute_Grapple_B_UpgradeDescription", "Gain a bonus action after grappling. Limited per turn.")
